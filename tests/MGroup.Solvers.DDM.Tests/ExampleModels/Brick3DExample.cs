...
namespace MGroup.Solvers.DDM.Tests.ExampleModels
{
	public class Brick3DExample
	{
		...
		public static Model CreateSingleSubdomainModel()
		{
			...
			builder.MaterialHomogeneous = new ElasticMaterial3D(E, v);
			...
			{
				INode node = model.NodesDictionary[nodeID];
				...
				dirichletBCs.Add(new NodalDisplacement(node, StructuralDof.TranslationZ, 0));
			}
